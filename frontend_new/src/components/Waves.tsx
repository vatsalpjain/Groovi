...
const Waves: React.FC<WavesProps> = ({
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 bg-[#160000] rounded-full w-[0.5rem] h-[0.5rem] pointer-events-none"
        style={{
          transform: 'translate3d(calc(var(--x) - 50%), calc(var(--y) - 50%), 0)',
          willChange: 'transform',
          opacity: 0, /* Hide the cursor dot but keep for debugging if needed */
        }}
      />
